class PlayersController < ApplicationController
  ...
  private
  def player_params
    params.require(:player).permit(:first_name, :last_name, :character_class_id, :clearing_id, :game_id, :great_treasures_vps, :usable_spells_vps, :fame_vps, :notoriety_vps, :gold_vps, :ready, :fame, :gold, :notoriety, :action_queue_id, :hidden, :found_hidden_enemies, :wounds, :fatigue, :dead, :block)
  end
