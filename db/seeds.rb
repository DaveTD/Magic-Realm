  ...
  Clearing.create(tile_id: 1, movement_type: 'mountain', movement_value: 2, clearing_number: 0, exit: true, x:190, y:6)
  Clearing.create(tile_id: 1, movement_type: 'mountain', movement_value: 2, clearing_number: 6, exit: false, x:180, y:62)
  ...
  Clearing.create(tile_id: 5, movement_type: 'wood', movement_value: 1, clearing_number: 1, exit: false, x:557, y:210)
  ...
  Clearing.create(tile_id: 6, movement_type: 'cave', movement_value: 1, clearing_number: 6, exit: false, x:110, y:250)
...
Player.create(game_id: game.id, clearing_id: 1, first_name: 'Joe', last_name: 'Blow')
